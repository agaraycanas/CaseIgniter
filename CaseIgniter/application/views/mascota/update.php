...
<form class="row col-sm-4" id="idForm" action="<?= base_url() ?>mascota/update_post" method="post">
	...
	<div class="form-group">
		...
		<input id="id-nombre" type="text" name="nombre" value="<?=  $body['mascota']->nombre ?>" class="form-control" onkeypress="detect(event);">
	</div>
