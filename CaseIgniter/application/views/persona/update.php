	...
	<fieldset class="scheduler-border">
		...
		<div class="form-check form-check-inline">
			<?php foreach ($body['aficion'] as $aficion ): ?>
				<input class="form-check-input" type="checkbox" id="id-aficiones-<?=$aficion->id ?>" name="aficiones[]" value="<?= $aficion->id ?>" <?= checked($body['persona']->aggr('ownAficionesList','aficion'), $aficion->id ) ?>>
