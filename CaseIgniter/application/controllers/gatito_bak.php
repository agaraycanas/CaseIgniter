...
class gatito extends CI_Controller {	
	...
	*/
	public function create_post() {
		...
		$expuesto = ( isset( $_POST['expuesto']) ? $_POST['expuesto'] : null );
		...
		try {
			$id = $this->gatito_model->create( $nombre, $expuesto, $loginname, $password, $roles );
			$this->list_id($id);
		}
		catch (Exception $e) {
			$data['status'] = 'error';
	...
	*/
	public function updatePost() {
		...
		$is_admin = ( isset($_SESSION['rol']) && $_SESSION['rol']->nombre == 'admin' );		try {
			$this->gatito_model->update( $id, $nombre, $expuesto, $loginname, $roles, $is_admin );
