...
class _casei extends CI_Controller
{
    ...
    public function homePOST()
    {
        ...
        $this->csi_update_model_txt_file($debug, $model_data);
        $this->csi_update_model_img_txt_file($debug, $data);
     ...
     *            data
     */
    private function csi_update_model_img_txt_file($debug, $data)
    {
        if ($debug) {
     ...
     *            model_data
     */
    private function csi_update_model_txt_file($debug, $model_data)
    {
        if ($debug) {
