...
class persona extends CI_Controller {
	...
	*/
	public function create_post() {
		...
		$ciudadanos = ( isset( $_POST['ciudadanos']) ? $_POST['ciudadanos'] : [] );
		...
		try {
			$id = $this->persona_model->create( $nombre, $fechanacimiento, $peso, $amo, $ciudadanos, $expertoen, $inutilen, $gusta, $odia );
			$this->list_id($id);
		}
		catch (Exception $e) {
			$data['status'] = 'error';
	...
	*/
	public function update_post() {
		...
		try {
			$this->persona_model->update( $id, $nombre, $fechanacimiento, $peso, $amo, $ciudadanos, $expertoen, $inutilen, $gusta, $odia );
