...
class persona_model extends CI_Model {
	...
	*/
	public function create( $nombre, $fechanacimiento, $peso, $amo, $paisnacimiento, $gusta, $odia, $expertoen, $inutilen ) {
	...
	*/
	public function update( $id, $nombre, $fechanacimiento, $peso, $amo, $paisnacimiento, $gusta, $odia, $expertoen, $inutilen ) {
