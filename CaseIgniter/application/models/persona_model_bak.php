...
class persona_model extends CI_Model {
	...
	*/
	public function create( $nombre, $fechanacimiento, $peso, $foto, $amo, $paisnacimiento, $expertoen, $inutilen, $gusta, $odia ) {
	...
	*/
	public function update( $id, $nombre, $fechanacimiento, $peso, $foto, $amo, $paisnacimiento, $expertoen, $inutilen, $gusta, $odia ) {
	...
	*/
	public function get_filtered($filter) {
		...
		return R::findAll('persona', implode(' OR ', $where_clause) , [ $f,$f,$f,$f,$f,$f,$f,$f,$f,$f ] );
