...
class persona_model extends CI_Model {
	...
	*/
	public function create( $nombre, $fechanacimiento, $peso, $foto, $amo, $paisnacimiento, $expertoen, $inutilen, $gusta, $odia, $loginname, $password, $roles ) {
	...
	if ( $foto != NULL && $foto['error'] == UPLOAD_ERR_OK) {
		...
		$file_name = 'persona' . '-' . 'foto' . '-' . $id_bean . '.' .$ext ;
	...
	*/
	public function update( $id, $nombre, $fechanacimiento, $peso, $foto, $amo, $paisnacimiento, $expertoen, $inutilen, $gusta, $odia, $loginname, $password, $roles ) {
	...
	*/
	public function get_filtered($filter) {
		...
		$where_clause[] = '(SELECT count(*) FROM rol WHERE nombre LIKE ? AND rol.id IN (SELECT rol_id FROM roles WHERE persona_id = persona.id)) > 0';
		$f = "%$filter%";
		
		return R::findAll('persona', implode(' OR ', $where_clause) , [ $f,$f,$f,$f,$f,$f,$f,$f,$f,$f,$f,$f,$f ] );
