...
class usuario_model extends CI_Model {
	...
	*/
	public function get_filtered($filter) {
		...
		$where_clause[] = '(SELECT anyoini FROM cursoacademico WHERE cursoacademico.id = usuario.id) LIKE ?';
		$where_clause[] = '(SELECT nombre FROM departamento WHERE departamento.id = usuario.id) LIKE ?';
